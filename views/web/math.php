...
<div class="mtx-form-group">
    <label for="advcaptcha">
        ...
        <span class="advcaptcha-refresh" data-type="math"><img src="<?php echo advcaptcha_url('assets/web/img/refresh.svg'); ?>" alt="<?php _e('Refresh', advcaptcha_plugin()); ?>" title="<?php _e('Refresh', advcaptcha_plugin()); ?>"></span>
    </label>
